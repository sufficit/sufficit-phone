...
public:
	...
	typedef void (*OperationGetStringCallback)(Result result, bool binary, const char *string, gpointer data);
	...
	static gpointer store_network_password(const gchar *keyring,
	...
	static gpointer find_network_password(const gchar *user,
	                                      const gchar *server,
	                                      const gchar *type,
	...
	static gpointer delete_network_password(const gchar *user,
	                                        const gchar *server,
	                                        OperationDoneCallback callback,
	                                        gpointer data,
	                                        GDestroyNotify destroy_data);
...
private:
	...
	typedef gpointer(store_password_fn)(const PasswordSchema *schema,
	                                    const gchar *keyring,
	                                    const gchar *display_name,
	                                    const gchar *password,
	                                    OperationDoneCallback callback,
	...
	typedef gpointer(find_password_fn)(const PasswordSchema *schema,
	                                   ...
	                                   GDestroyNotify destroy_data,
	                                   ...);
	typedef gpointer(delete_password_fn)(
	    const PasswordSchema *schema, OperationDoneCallback callback, gpointer data, GDestroyNotify destroy_data, ...);
